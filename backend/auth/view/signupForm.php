                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="password" name="passwordConfirm" id="passwordConfirm" required="required" placeholder="ton plat préféré" class="default&#x20;form-control" value="" maxlength="255"> </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                <label class="col-sm-4&#x20;control-label" for="contact-fieldset&#x5B;0&#x5D;&#x5B;mail&#x5D;">Voulez vous être aussi un intervenant ? &nbsp;<span class="text-danger">*</span>
                                                </label>

                                                <div class="col-sm-8">
                                                    <div class="input-group">
                    <div class="checkbox checkbox-success checkbox-inline">
                        <input type="checkbox" name ="intervenant" class="styled" id="inlineCheckbox2" value="1" checked>
