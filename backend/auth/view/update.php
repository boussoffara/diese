                                    ...
                                    <fieldset id="contact-fieldset">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="pseudo" required="required" placeholder="Pr&#xE9;nom" class="default&#x20;form-control" value="pseudo"> </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="prenom" required="required" placeholder="Nom" class="default&#x20;form-control" value="<?php if($contact->id != -1){ echo $contact->nom; } ?>" maxlength="255"> </div>
                                            </div>
