<?php
function display_all_contacts($contacts){
    ...
    <div class="row">
            <div class="col-lg-6 btn-toolbar pull-left" style="margin-bottom: 16px" role="toolbar">
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-success text-center" data-toggle="tooltip" title="Ajouter un partenariat" onclick="location.href='edit.php'"><i class="fa fa-plus-circle fa-lg"></i>&nbsp;<span class="hidden-xs">Nouveau</span></button>
        ...
        // Show defined records.
            ...
            <div class="row row-eq-height">
                <?php foreach($contacts as $contact){
                     display_contactElement($contact);
                 } ?>
            </div>
        <?php endif ?>
        </div>
