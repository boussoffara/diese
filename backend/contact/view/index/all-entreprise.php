<?php
function display_all_entreprise($contacts){
    ...
    $noneTitle   = 'Il n\'y a aucune entreprise défini.';
    $addTitle    = 'Ajouter une entreprise';
    $deleteTitle = 'Êtes-vous sûr de vouloir supprimer cet entreprise ?';
    ...
    <div class="row">
            <div class="col-lg-6 btn-toolbar pull-left" style="margin-bottom: 16px" role="toolbar">
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-success text-center" data-toggle="tooltip" title="Ajouter un partenariat" onclick="location.href='editentreprise.php'"><i class="fa fa-plus-circle fa-lg"></i>&nbsp;<span class="hidden-xs">Nouveau</span></button>
        ...
        // Show defined records.
            ...
            <div class="row row-eq-height">
                <?php foreach($contacts as $contact){
                     display_entrepriseElement($contact);
                 } ?>
            </div>
        <?php endif ?>
        </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <div>Êtes-vous sûr de vouloir supprimer ce contact ?</div>
            <div id="Group"></div>
            <div id="User"></div>
            <div id="Right"></div>
        </div>
