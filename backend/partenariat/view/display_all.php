...
function display_partnerships($jobs){
    $count=count($jobs);
        $title        = 'Liste des partenariats';
    $noneTitle   = 'Il n\'y a aucune partenariat défini.';
    $addTitle    = 'Ajouter une partenariat';
    $deleteTitle = 'Êtes-vous sûr de vouloir supprimer cette partenariat ?';
    ...
    <div class="row">
            <div class="col-lg-6 btn-toolbar pull-left" style="margin-bottom: 16px" role="toolbar">
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-success text-center" data-toggle="tooltip" title="Ajouter un partenariat" onclick="location.href='/backend/partenariat/controller/edit.php'"><i class="fa fa-plus-circle fa-lg"></i>&nbsp;<span class="hidden-xs">Nouveau</span></button>
...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-info">
                 ...
                 <!-- Panel Header -->
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-phone fa-fw fa-lg"></i>&nbsp;<span class="hidden-xs">Liste des partenariats</span>
                </div><!-- /.panel-heading -->
                </div>
